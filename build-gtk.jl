...
;;
(defvar gtk-type-alist
  '((type "GtkType" "sgtk_rep_to_type" "sgtk_type_to_rep" "sgtk_valid_type")
    (char "gchar" "sgtk_rep_to_char" "sgtk_char_to_rep" "sgtk_valid_char")
    (bool "int" "sgtk_rep_to_bool" "sgtk_bool_to_rep" nil)
    (int "gint" "sgtk_rep_to_int" "sgtk_int_to_rep" "sgtk_valid_int"
     (listable . t))
    (uint "guint" "sgtk_rep_to_uint" "sgtk_uint_to_rep" "sgtk_valid_uint"
     (listable . t))
    (long "glong" "sgtk_rep_to_long" "sgtk_long_to_rep" "sgtk_valid_long")
    (ulong "gulong" "sgtk_rep_to_ulong" "sgtk_ulong_to_rep" "sgtk_valid_ulong")
    (float "gfloat" "sgtk_rep_to_float" "sgtk_float_to_rep" "sgtk_valid_float")
    (string "char*" "sgtk_rep_to_string" "sgtk_string_to_rep"
    ...
    (boxed output-complex-type output-rep-to-boxed output-boxed-to-rep
     output-boxed-pred (listable . t))
    (pointer "gpointer" "sgtk_rep_to_pointer" "sgtk_pointer_to_rep"
     "sgtk_pointerp")
    (object output-complex-type output-rep-to-object output-object-to-rep
     output-object-pred (listable . t))
    (static_string "char*" nil "sgtk_static_string_to_rep" nil (listable . t))
    (full-callback "repv" output-rep-to-full-callback nil "sgtk_valid_function"
     (c2args . output-full-callback-args))
    (file-descriptor "int" "sgtk_rep_to_fd" nil "sgtk_valid_fd")
    (list "GList*" output-rep-to-list output-list-to-rep output-cvec-pred
     (finish . output-list-finish))
    (slist "GSList*" output-rep-to-list output-list-to-rep output-cvec-pred
     (finish . output-slist-finish))
    (cvec "sgtk_cvec" output-rep-to-cvec output-cvec-to-rep output-cvec-pred
     (finish . output-cvec-finish) (c2args . output-cvec-args))
    (cvecr "sgtk_cvec" output-rep-to-cvec output-cvec-to-rep output-cvec-pred
     (finish . output-cvec-finish) (c2args . output-cvec-args))
    (fvec "sgtk_cvec" output-rep-to-cvec output-cvec-to-rep output-cvec-pred
     (finish . output-cvec-finish) (c2args . output-cvec-args))
    (ret "sgtk_cvec" output-rep-to-cvec output-cvec-to-rep output-cvec-pred
     (finish . output-cvec-finish) (c2args . output-cvec-args))
;   (double "gdouble" "sgtk_rep_to_double" "sgtk_double_to_rep" "sgtk_doublep")
    (point "GdkPoint" "sgtk_rep_to_point" "sgtk_point_to_rep"
     "sgtk_valid_point")
    (SCM "repv" "" "" nil)))
